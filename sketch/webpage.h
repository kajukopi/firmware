...
<head>
  ...
  <style>
    ...
    .sidebar {position:fixed;left:0;top:0;width:220px;height:100vh;background:#212529;z-index:2000;}
...
<div class="sidebar" id="sidebar" style="display:none;">
  ...
  <ul>
    <li><a href="#" class="text-white" onclick="page('home')">Home</a></li>
    <li><a href="#" class="text-white" onclick="page('ota')">OTA Update</a></li>
  </ul>
</div>
